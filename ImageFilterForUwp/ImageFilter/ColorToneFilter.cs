...
{
    public class ColorToneFilter : IImageFilter
    {
        double _hue;
        double _saturation;
        ...
        */
        ...
        {
		    return MyImage.rgb(MyImage.SAFECOLOR((int)(r*255)), MyImage.SAFECOLOR((int)(g*255)),MyImage.SAFECOLOR((int)(b*255)));
        }

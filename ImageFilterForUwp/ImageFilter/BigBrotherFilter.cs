...
{
    public class BigBrotherFilter : IImageFilter
    {

        private const int DOT_AREA = 10;
        private int[] arrDither = new int[]{ 
                167,200,230,216,181,
                94,72,193,242,232,
                36,52,222,167,200,
                181,126,210,94,72,
        ...
        private void drawTone(int a_x, int a_y, MyImage imageIn)
        {
            int l_grayIntensity;
            int l_x;
            int l_y;

...
{
    public class LensFlareFilter : RadialDistortionFilter
    {
        ...
        class Reflect
        {
            public FloatRGB ccol = new FloatRGB();
            public double size;
            public int xp;
            public int yp;
            public int type;
        ...
        static int fixpix(int color, double procent, FloatRGB colpro)
        {
            ...
            return MyImage.rgb(colorR, colorG, colorB);
        }
        ...
        public override MyImage process(MyImage imageIn)
        {

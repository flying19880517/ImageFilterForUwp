...
namespace HaoRan.ImageFilter
{
    public class ParamEdgeDetectFilter : ConvolutionFilter
    {
        ...
        private MyImage ProcessColor(int k00, int k01, int k02, int k20, int k21, int k22, MyImage imageIn, int thresholdSq)
        {
            int width = imageIn.getWidth();
            int height = imageIn.getHeight();
            int r, g, b;
            MyImage clone = imageIn.clone();
        ...
        private MyImage ProcessGray(int k00, int k01, int k02, int k20, int k21, int k22, MyImage imageIn, int thresholdSq)
        {
            int width = imageIn.getWidth();
            int height = imageIn.getHeight();
            MyImage clone = imageIn.clone();

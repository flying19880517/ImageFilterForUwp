...
namespace HaoRan.ImageFilter
{
    public class PixelateFilter : IImageFilter
    {
         ...
         * @return
         */
        private int getPredominantRGB(MyImage imageIn, int a_x, int a_y, int squareSize)
        {
            int red = -1;
            int green = -1;
            int blue = -1;
         ...
         * @param a_rgb
         */
        private void fillRect(MyImage imageIn, int a_x, int a_y, int squareSize, int a_rgb)
        {
            for (int x = a_x; x < a_x + squareSize; x++)
            {
                for (int y = a_y; y < a_y + squareSize; y++)
